...
function love.load()
  ...
  test0 = Entity(vector(0,0), 48, 72, love.graphics.newImage('assets/sprites/player-sheet.png'))
  test1 = AnimatedEntity(vector(0,0), 48, 72, 12, 18, love.graphics.newImage('assets/sprites/player-sheet.png'))
  Talkies.say("Title", "Hello World!")

  Binocles()
  Binocles:watch("FPS", function() return math.floor(1/love.timer.getDelta()) end)
  Binocles:watch("watch",function() return test1 end)
